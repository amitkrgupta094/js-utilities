 ...
 * P.S. Practically, there's no need for this function since it is a simple wrapper. However,
 * it is useful to know how to determine the number of parameters a function expects, which
 * is useful for questions like Curry II.
 *
 * function foo() {}
 * function bar(a) {}
 * function baz(a, b) {}
